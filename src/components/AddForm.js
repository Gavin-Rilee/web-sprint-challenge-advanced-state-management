...
import { addSmurf, updatedError } from "../actions/index";
...
const AddForm = (props) => {
    ...
    return(<section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {
                errorMessage && <div data-testid="errorAlert" className="alert alert-danger" role="alert">
                    
                    Error: {props.errorMessage}</div>
            }
...
export default connect(mapStateToProps,{ addSmurf, updatedError })(AddForm);
